...
<head>
  ...
  <title>Tambah Wisata - Jawa Tengah</title>
</head>
    <body class="">
        <h1 class="flex justify-center font-bold mt-5 text-4xl">Tambahkan Wisata Di Jawa Tengah</h1>
        <div class="flex items-center justify-center p-12">

            <div class="mx-auto w-full max-w-[550px] bg-white">
                <form method="POST" action="/addjateng" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-5">
