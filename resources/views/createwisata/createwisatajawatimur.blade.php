...
<head>
  ...
  <title>Tambah Wisata - Jawa Timur</title>
</head>
    <body class="">
        <h1 class="flex justify-center font-bold mt-5 text-4xl">Tambahkan Wisata Di Jawa Timur</h1>
        <div class="flex items-center justify-center p-12">

            <div class="mx-auto w-full max-w-[550px] bg-white">
                <form method="POST" action="/addjatim" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-5">
