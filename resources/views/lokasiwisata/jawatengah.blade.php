...
<body class="bg-gray-100 font-poppins">
  ...
  <div class="container mx-auto py-10 px-6">
      <div id="searchResults" class="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
          @forelse($jawatengahs as $jawatengah)
          <div class="max-w-xs mx-auto  bg-white shadow-lg overflow-hidden rounded-lg">
              ...
              <div class="p-4">
                  ...
                  <p class="text-gray-700 mt-4 text-base">{{ $jawatengah->rating }}</p>
                  <p class="text-gray-700 text-sm"><span class="font-semibold">*Places to visit: </span> {{ $jawatengah->lokasi }}</p>
              </div>
          </div>
          @empty
